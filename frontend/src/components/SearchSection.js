...
const SearchSection = () => {
    return (
        <div className='bg-[#DADBF0]'>
            <div className='w-10/12 mx-auto py-12 md:py-28 text-center flex flex-col items-center gap-5'>
                <h2 className='text-3xl md:text-5xl font-semibold'>How can we help?</h2>
                <form className='w-11/12 md:w-8/12 bg-white py-2 px-4 rounded flex items-center justify-end'>
