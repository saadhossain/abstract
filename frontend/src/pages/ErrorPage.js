        ...
        <section className="flex items-center p-16">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                <div className="max-w-md text-center">
                    ...
                    <p className="text-2xl font-semibold md:text-3xl">Sorry, Content not Found.</p>
                    <p className="mt-4 mb-8">But dont worry, you can find plenty of other things on our homepage.</p>
                    <Link to='/' className="px-8 py-3 font-semibold rounded-full bg-gray-900 hover:bg-black text-white">Back to Home</Link>
                </div>
            </div>
        </section>
    );
